...
const ConfirmConvertModal: React.FC<ConfirmConvertModalProps> = ({ 
  isOpen, 
  onClose, 
  onConfirm, 
  funcionarioNome,
      ...
      <div className="sm:flex sm:items-start">
        ...
        <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
          <p className="text-sm text-gray-500">
            Tem certeza de que deseja converter o funcionário "{funcionarioNome}" de "Treinamento" para "Autônomo"?
          </p>
        </div>
      </div>
